...
// ** Icons Imports
import { BiChevronDown, BiChevronUp, BiDotsVertical } from 'react-icons/bi'
...
const data: DataType[] = [
  {
    ...
    trendNumber: '25.8%',
    avatarColor: 'success',
    trend: <BiChevronUp style={{ color: 'success.main', fontWeight: 600 }} />
  },
  {
    sales: '645k',
    subtitle: 'UK',
    ...
    trendNumber: '6.2%',
    avatarColor: 'error',
    trend: <BiChevronDown style={{ color: 'error.main', fontWeight: 600 }} />
  },
  {
    sales: '148k',
    title: '$865k',
...
const SalesByCountries: React.FC<{}> = () => {
  return (
    <Card>
      <CardHeader
